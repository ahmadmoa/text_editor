...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_option_t, stringdata0) + ofs), len 
...
const QMetaObject option::staticMetaObject = { {
    ...
    qt_meta_stringdata_option.offsetsAndSize,
    qt_meta_data_option,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_option_t
